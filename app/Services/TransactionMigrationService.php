...
class TransactionMigrationService extends MigrationService{
    ...
    public static function migrateTransaction1():void{
      ...
      $pendingTransactions = Transaction::where('status', 0)->where('cron_id', 1)->select('member_reference', 'status', 'product_code', 'branch_code', 'transaction_reference', 'channel', 'product_code', 'transaction_type')->limit(1000);
